...
This project is indexed by GitNexus as **taskflow-mvp** (2395 symbols, 5670 relationships, 171 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/taskflow-mvp/context` | Codebase overview, check index freshness |
| `gitnexus://repo/taskflow-mvp/clusters` | All functional areas |
| `gitnexus://repo/taskflow-mvp/processes` | All execution flows |
| `gitnexus://repo/taskflow-mvp/process/{name}` | Step-by-step execution trace |
