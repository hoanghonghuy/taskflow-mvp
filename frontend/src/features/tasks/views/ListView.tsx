  ...
  return (
    <AppPage>
      ...
      <button
        ...
        className="flex fixed md:absolute bottom-[calc(5rem+env(safe-area-inset-bottom,0px))] md:bottom-8 right-4 md:right-8 bg-primary text-primary-foreground rounded-full p-4 shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 transition-all hover:scale-105 hover:opacity-90 active:scale-95 motion-reduce:hover:scale-100 motion-reduce:active:scale-100 z-20"
