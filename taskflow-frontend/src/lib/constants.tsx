...
export const PRIORITY_MAP: { [key in Priority]: { label: string; icon: React.FC<{ className?: string }>; color: string; checkboxBorderColor: string } } = {
  none: { label: 'priority.none', icon: FlagIcon, color: 'text-muted-foreground', checkboxBorderColor: 'border-muted-foreground/50' },
  low: { label: 'priority.low', icon: FlagIcon, color: 'text-blue-500', checkboxBorderColor: 'border-blue-500' },
  medium: { label: 'priority.medium', icon: FlagIcon, color: 'text-yellow-500', checkboxBorderColor: 'border-yellow-500' },
  high: { label: 'priority.high', icon: FlagIcon, color: 'text-red-500', checkboxBorderColor: 'border-red-500' },
  urgent: { label: 'priority.urgent', icon: FlagIcon, color: 'text-red-600', checkboxBorderColor: 'border-red-600' },
}
