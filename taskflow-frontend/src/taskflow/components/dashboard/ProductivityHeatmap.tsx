        ...
        <div ref={containerRef} className="bg-card border border-border p-4 rounded-lg overflow-hidden">
            ...
            <div className="mt-4 flex items-center justify-end gap-2 text-xs text-muted-foreground">
                ...
                <div className="flex items-center gap-1" aria-hidden="true">
                    <span className="block h-3 w-3 rounded-sm bg-secondary" />
                    <span className="block h-3 w-3 rounded-sm bg-primary/20" />
                    <span className="block h-3 w-3 rounded-sm bg-primary/40" />
                    <span className="block h-3 w-3 rounded-sm bg-primary/70" />
