...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, onChatbotToggle, onShareList }) => {
    ...
    const NavItem: React.FC<{
        ...
        <div
            ...
            className={`w-full flex items-center justify-between text-sm px-3 py-2 rounded-md transition-colors group focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 ${
                isActive ? 'bg-primary/10 text-primary font-semibold ring-0' : 'hover:bg-muted/50'
            }`}
        >
            {children}
        </div>
                ...
                <div className="flex-grow overflow-y-auto pr-1 min-w-[15rem]">
                    ...
                    <div className="pt-4">
                        <div className="flex items-center justify-between px-3 mb-2">
                            ...
                            <button type="button" onClick={() => setIsListsExpanded(!isListsExpanded)} className="p-1 rounded-md hover:bg-muted/50">
                    ...
                    <div className="pt-4">
                        <div className="flex items-center justify-between px-3 mb-2">
                            ...
                            <button type="button" onClick={() => setIsTagsExpanded(!isTagsExpanded)} className="p-1 rounded-md hover:bg-muted/50">
