...
| Recurrence | Task lặp lại | ✅ | UI TaskDetail (daily/weekly/monthly); complete → advance `dueDate`; calendar expand preview instances |
...
| ~~**P3**~~ | ~~Recurrence UI+logic~~ | ✅ Done: UI + advance + calendar expand |
